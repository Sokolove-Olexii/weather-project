...
export default function DarkTheme() {
  ...
  const getColorPreference = () => {
    if (typeof window === "undefined") return "light"; // Для SSR (Next.js и т.д.)
  ...
  // Эффект для применения темы к HTML и сохранения в LocalStorage
  useEffect(() => {
  ...
  // Эффект для отслеживания системных настроек
  useEffect(() => {
